      ...
      <main className="mx-auto flex min-h-screen w-full max-w-md flex-col px-6 py-8">
        <header className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-[#5b6780]">
            Step 1 of 2: account details. Step 2: email verification.
          </p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 rounded-3xl border border-[#e3eaf7] bg-white p-5 shadow-[0_20px_40px_-28px_rgba(12,20,29,0.35)]">
          ...
          <div className="space-y-1.5">
            <label htmlFor="phone" className="text-sm font-semibold text-[#2b3957]">
            ...
            <input
              ...
              className={inputClassName}
            />
            <p className="text-xs text-[#7b88a3]">Used for account recovery and urgent updates.</p>
          </div>
